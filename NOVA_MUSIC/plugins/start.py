...
from NOVA_MUSIC import Telegram, YouTube, app
from NOVA_MUSIC.misc import SUDOERS, _boot_
from NOVA_MUSIC.plugins.playlist import del_plist_msg
from NOVA_MUSIC.plugins.sudoers import sudoers_list
from NOVA_MUSIC.utils.database import (add_served_chat,
                                       add_served_user,
                                       get_served_chats,
                                       get_served_users,
                                       blacklisted_chats,
...
from NOVA_MUSIC.utils.decorators.language import LanguageStart
from NOVA_MUSIC.utils.formatters import get_readable_time
from NOVA_MUSIC.utils.inline import (help_pannel, private_panel,
                                     start_pannel)
        ...
        if name[0:3] == "sta":
            ...
            def get_stats():
                ...
                for vidid, count in list_arranged.items():
                    ...
                    if vidid == "telegram":
                        msg += f"🔗[ᴛᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ](https://t.me/devilz_bots) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                    else:
            ...
            key = InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="• sᴜᴩᴩᴏʀᴛ •", url="https://t.me/devilz_support"
                        ),
                    ],
                ]
            )
