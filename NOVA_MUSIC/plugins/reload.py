...
from NOVA_MUSIC.utils.database import get_authuser_names, get_cmode
from NOVA_MUSIC.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await NOVA.stop_stream(message.chat.id)
    except:
        pass
