...
import config
from NOVA_MUSIC import Carbon, YouTube, app
from NOVA_MUSIC.core.call import NOVA
from NOVA_MUSIC.misc import db
from NOVA_MUSIC.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from NOVA_MUSIC.utils.exceptions import AssistantErr
from NOVA_MUSIC.utils.inline.play import (stream_markup, queue_markup,
                                          telegram_markup)
from NOVA_MUSIC.utils.inline.playlist import close_markup
from NOVA_MUSIC.utils.pastebin import NOVAbin
from NOVA_MUSIC.utils.stream.queue import put_queue, put_queue_index
from NOVA_MUSIC.utils.thumbnails import gen_thumb, gen_qthumb
...
async def stream(
    ...
    if forceplay:
        await NOVA.force_stop_stream(chat_id)
